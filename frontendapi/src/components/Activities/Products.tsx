...
import { deleteActivityRequest } from "../../api/apiActivities";
...
const Products: React.FC = () => {
  ...
  const location = useLocation(); // Hook para obtener el estado de la ubicación

  // Usar useEffect para actualizar la lista de productos cuando se edita un producto
  useEffect(() => {
  ...
  const handleEdit = (id: string) => {
    navigate(`/edit-product/${id}`); // Redirige a la página de edición
  };
